...
public class GeminiProperties {
  ...
  public static final String SUMMARY_PROMPT = "Summarize the following into a Korean review title (max 100 characters). No explanation only return the title in Korean.";
}
